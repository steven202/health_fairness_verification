#!/usr/bin/env python
# encoding: utf-8
# The original file is written by Minh Nguyen and CBIG under MIT license:
# https://github.com/ThomasYeoLab/CBIG/blob/master/LICENSE.md
# I modified it based on the original file.
...
def gender_convert(value):
    ...
    book = {v: k for k, v in book.items()}
...
def checkAgeRange(age):
    las_dig = age % 10
    range_age = str.format("Age {0}-{1}", age - las_dig, ((age - las_dig) + 10))
    return range_age


def checkEduRange(age):
    num = 3
    las_dig = age % num
    range_age = str.format("Edu {0}-{1}", age - las_dig, ((age - las_dig) + num))
    return range_age
